...
import (
	...
	"github.com/Legacynnn/goCodeBank/dto"
	"time"
)
...
func (u UseCaseTransaction) ProcessTransaction(transactionDto dto.Transaction) (domain.Transaction, error) {
	...
	t.ProcessAndValitade(creditCard)
...
func (u UseCaseTransaction) hydrateCreditCard(transactionDto dto.Transaction) *domain.CreditCard {
	...
	creditCard.ExpirationMonth = transactionDto.ExperationMonth
	creditCard.ExpirationYear = transactionDto.ExperationYear
